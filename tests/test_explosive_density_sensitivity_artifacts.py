...
def test_saved_density_model_outputs_match_generated_results():
    expected = (
        build_gole_gohar_explosive_density_sensitivity_table()
    )
...
def test_saved_density_ensemble_summary_matches_generated_results():
    model_outputs = (
        build_gole_gohar_explosive_density_sensitivity_table()
    )

    expected = build_explosive_density_ensemble_summary(
        model_outputs
    )
...
def test_saved_density_model_response_matches_generated_results():
    model_outputs = (
        build_gole_gohar_explosive_density_sensitivity_table()
    )
